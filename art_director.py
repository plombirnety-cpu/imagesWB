...
_CITY_NEOCREST_QUALITY_HINT = (
    ...
    "оставь пустыми; has_human_figure=false. Выбери один безошибочно узнаваемый "
    "главный ориентир, максимум два вспомогательных и один правдивый географический "
    "мотив. Не смешивай разные мосты, храмы, башни или дворцы в выдуманное здание; "
    "крупная геометрия важнее количества окон и декора. Композиция — вертикальный "
    "фигурный городской неогерб из трёх планов: большой частичный символ сзади, "
    "архитектурный ансамбль в середине и широкий передний мотив, который соединяет "
    "сцену с нижней плашкой. Нижние 27-30% отданы одной прямой строке названия. "
    "Используй 6-7 сочных непрозрачных печатных цветов, тёмный контур, жёсткий блик "
    "и тень, единый свет сверху слева и трёхступенчатую внешнюю кромку. Все буквы "
    "только настоящая русская кириллица: ни одной латинской буквы, перевода, даты, "
    "цифры, микротекста или псевдонадписи. Никакого прямоугольного постера, открытки, "
    "фото, герба, флага, официального знака, белой общей подложки, sticker-cutline, "
    "фотореализма, CGI-глянца, мягких градиентов, тонкой филиграни или шума."
)
