...
_MAGAZINE_COVER_QUALITY_HINT = (
    " ДЛЯ ЭТОГО дизайна строго соблюдай утверждённую сетку журнальной обложки: "
    "ВЕРТИКАЛЬ 2:3; один канонически узнаваемый персонаж крупным портретом по грудь "
    "занимает 70-85% высоты; лицо резкое и красивое, руки вне кадра; огромный "
    ...
    "Энергия героя выражается взглядом, волосами и компактными эффектами, а НЕ широкой "
    "боевой сценой, мелкой фигурой или сложными кистями. Вся свободная площадь и каждый "
    "край холста — идеально ровный выбранный green/blue chroma без градиента, текстуры, "
    "комнаты, пейзажа, бумажной карточки или рамки."
)
